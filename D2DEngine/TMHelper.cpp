...
namespace MYTM
{
	...
	D2D1_MATRIX_3X2_F MakeRotationMatrix(FLOAT angle, Vector2 center /*= D2D1::Point2F()*/)
	{
	...
	D2D1_MATRIX_3X2_F MakeScaleMatrix(D2D1_SIZE_F size, Vector2 center /*= D2D1::Point2F()*/)
	{
		D2D1_MATRIX_3X2_F _translateToOrigin = MakeTranslationMatrix(D2D1::Size(-center.x, -center.y));
